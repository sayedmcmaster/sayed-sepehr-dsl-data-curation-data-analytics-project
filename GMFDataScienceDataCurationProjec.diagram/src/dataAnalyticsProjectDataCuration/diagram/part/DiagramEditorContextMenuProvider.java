...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	...
	* @generated
	*/
	private dataAnalyticsProjectDataCuration.diagram.part.DeleteElementAction deleteAction;
	...
	*/
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		super(part, viewer);
		this.part = part;
		deleteAction = new dataAnalyticsProjectDataCuration.diagram.part.DeleteElementAction(part);
		deleteAction.init();
	}
