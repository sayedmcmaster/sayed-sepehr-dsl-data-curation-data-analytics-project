 ...
 * @generated
 */
public class DataAnalyticsProjectDataCurationInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog.openError(getShell(),
					dataAnalyticsProjectDataCuration.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogTitle,
					dataAnalyticsProjectDataCuration.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogMessage);
			return;
		}
		Wizard wizard = new dataAnalyticsProjectDataCuration.diagram.part.DataAnalyticsProjectDataCurationNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(
				NLS.bind(dataAnalyticsProjectDataCuration.diagram.part.Messages.InitDiagramFile_WizardTitle,
