...
/**
 * This is the item provider adapter for a {@link dataCurationStateTransitionAction.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.STATE__LABEL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.STATE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.STATE__IS_INITIAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.STATE__IS_FINAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.STATE__OUTGOING_TRANSITIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.STATE__INCOMING_TRANSITIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_states_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_states_feature", "_UI_State_type"),
				 DataCurationStateTransitionActionPackage.Literals.STATE__STATES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.STATE__TRANSITIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataCurationStateTransitionActionPackage.Literals.STATE__ACTION_TO_TAKE);
			childrenFeatures.add(DataCurationStateTransitionActionPackage.Literals.STATE__EVENT_TO_TAKE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataCurationStateTransitionActionPackage.Literals.STATE__ACTION_TO_TAKE,
				 DataCurationStateTransitionActionFactory.eINSTANCE.createAction()));

		newChildDescriptors.add
			(createChildParameter
				(DataCurationStateTransitionActionPackage.Literals.STATE__EVENT_TO_TAKE,
