...
/**
 * This is the item provider adapter for a {@link dataCurationStateTransitionAction.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.ATTRIBUTE__LABEL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.ATTRIBUTE__DATA_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Attribute.class)) {
			case DataCurationStateTransitionActionPackage.ATTRIBUTE__LABEL:
			case DataCurationStateTransitionActionPackage.ATTRIBUTE__NAME:
			case DataCurationStateTransitionActionPackage.ATTRIBUTE__DATA_TYPE:
