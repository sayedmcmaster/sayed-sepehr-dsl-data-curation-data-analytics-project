...
/**
 * This is the item provider adapter for a {@link dataCurationStateTransitionAction.DataValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataValueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataValue_Label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataValue_Label_feature", "_UI_DataValue_type"),
				 DataCurationStateTransitionActionPackage.Literals.DATA_VALUE__LABEL,
				 true,
				 false,
				 false,
	...
	protected void addRowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataValue_row_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataValue_row_feature", "_UI_DataValue_type"),
				 DataCurationStateTransitionActionPackage.Literals.DATA_VALUE__ROW,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((DataValue)object).getLabel();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataValue.class)) {
			case DataCurationStateTransitionActionPackage.DATA_VALUE__LABEL:
			case DataCurationStateTransitionActionPackage.DATA_VALUE__ROW:
