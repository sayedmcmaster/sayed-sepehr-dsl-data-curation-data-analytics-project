...
/**
 * This is the item provider adapter for a {@link dataCurationStateTransitionAction.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.ACTION__LABEL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.ACTION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_source_feature", "_UI_Action_type"),
				 DataCurationStateTransitionActionPackage.Literals.ACTION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataCurationStateTransitionActionPackage.Literals.ACTION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Action.class)) {
			case DataCurationStateTransitionActionPackage.ACTION__LABEL:
			case DataCurationStateTransitionActionPackage.ACTION__NAME:
